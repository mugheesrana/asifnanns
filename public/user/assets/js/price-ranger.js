...
$(document).ready(function () {
  ...
  if (rangeSlider) {
    // Get dynamic values from the server
    var priceMin = parseInt(document.getElementById('price-min').value) || 0;
    var priceMax = parseInt(document.getElementById('price-max').value) || 6000;
    var maxPrice = Math.max(priceMax, 6000); // Ensure we have a reasonable max
