...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Permissions Management</h3>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Add New Permission</h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                   placeholder="e.g., create-posts, manage-users" required>
                                    ...
                                    @forelse($permissions as $permission)
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                {{-- Edit --}}
                                                <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editPermission{{ $permission->id }}">
                                                ...
                                                <form action="{{ route('admin.permissions.destroy', $permission) }}" method="POST" style="display:inline-block">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" onclick="return confirm('Delete this permission?')" class="btn btn-sm btn-danger">
