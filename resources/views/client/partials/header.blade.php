...
<head>
    <meta charset="utf-8">
    <title>Nanns - Autos</title>

    <meta name="author" content="themesflat.com">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

    <link rel="stylesheet" href="/nanns/app/css/font-awesome.css">
    <link rel="stylesheet" href="../../../nanns/sibforms.com/forms/end-form/build/sib-styles.css">
    <link rel="stylesheet" href="/nanns/app/css/styles.css">


    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="/nanns/assets/images/logo/Favicon.png">
    <link rel="apple-touch-icon-precomposed" href="/nanns/assets/images/logo/Favicon.png">
    @yield('styles')
</head>
                                ...
                                <div class="inner-container flex justify-space align-center">
                                    ...
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="/">
                                                <img class="lazyload" data-src="{{asset('nanns/assets/images/logo/logo2.png')}}"
                                                    src="{{asset('nanns/assets/images/logo/logo2.png')}}" alt=""
                                                    width="115" height="40"></a></div>
                                    </div>
                                    ...
                                    <div class="header-account flex align-center">
                                        <div class="search-mobie">
                                            <a href=""
                                                class="header-search-icon flex items-center justify-center">
                                        ...
                                        <div class="flat-bt-top">
                                            <a class="sc-button" href="/custom-service-request">
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo"><a href="/">
                                <img class="lazyload" data-src="/nanns/assets/images/logo/logo@2x.png"
                                    src="/nanns/assets/images/logo/logo%402x.png" alt="" width="197"
                                    height="48"></a></div>
                        <div class="bottom-canvas">
                            ...
                            <div class="button-mobi-sell">
                                <a class="sc-button btn-icon center" href="/custom-service-request">
