             ...
             <div class="row">
                 ...
                 <div class="col-lg-3 col-sm-6 col-12">
                     <div class="widget widget-menu footer-col-block">
                         ...
                         <ul class="box-menu tf-collapse-content">
                             <li><a href="/car-listings">Land Rover</a></li>
                             <li><a href="/car-listings">Tesla</a></li>
                             <li><a href="/car-listings">Volkswagen</a></li>
                             <li><a href="/car-listings">Honda</a></li>
                             <li><a href="/car-listings">Hyundai</a></li>
                             <li><a href="/car-listings">Mercedes benz</a></li>
                         </ul>
                     </div>
                 </div>
                 ...
                 <div class="col-lg-3 col-sm-6 col-12">
                     <div class="widget widget-menu footer-col-block">
                         ...
                         <ul class="box-menu tf-collapse-content">
                             <li><a href="/custom-service-request">Request Service</a></li>
                 ...
                 {{-- <div class="col-lg-3 col-sm-6 col-12 ">
                                <div class="widget widget-menu widget-form footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        <p class="font-2">Stay on top of the latest car trends, tips, and tricks for selling your car.</p>
                                        <div class="sib-form">
                                            <div id="sib-form-container" class="sib-form-container">
                                                ...
                                                <div id="sib-container" class="sib-container--large sib-container--vertical">
                                                    <form id="sib-form" method="POST"
                                                        action="https://3c02c1a1.sibforms.com/serve/MUIFAL4m-zPku9fXpqCo24Qexb68h9xXPdxcpJFhE-_XEvRPxuRgi23DJpcLxjJ0d3jruEYDiaoapoDNLvNfekoHGspPvct3OX998KRfxoubbRPjZoXe5Le9r-8u7EEfgznVtOEguZC294bevm4vjVXhRaL6WsewB95RSIbbLQH_ylKm8cUOSsMb5Pd9dm4WXAWx3Jy5JGfiw0gE"                                                data-type="subscription">
                                                        ...
                                                        <div>
                                                            <div class="sib-form-block">
                                                                <button class="sib-form-block__button sib-form-block__button-with-loader tf-btn-4 light_skew_hover" form="sib-form" type="submit">
                 ...
                 <div class="col-lg-3 col-sm-6 col-12">
                     <div class="widget widget-menu footer-col-block">
                         ...
                         <ul class="box-menu tf-collapse-content">
                             <li><strong>Email:</strong> <a href="mailto:info@nannsauto.com">info@nannsauto.com</a></li>
                             <li><strong>Phone:</strong> <a href="tel:+16475730971">+1 (647) 573-0971</a></li>
                             <li><strong>Address:</strong> 22 Bach Ave, Whitby, ON L1R 2M1</li>
                         </ul>
                     </div>
                 </div>
             </div>
             ...
             <div class="row">
                 <div class="col-lg-4 col-md-12">
                     <div class="logo-footer style box-1">
                         <a href="/nanns/index.html">
                             <img class="lazyload" data-src="/nanns/assets/images/logo/logo-footer@2x.png"
                                 src="/nanns/assets/images/logo/logo-footer%402x.png" alt="img" width="80"
                                 height="40">
                         </a>
                     </div>
                 </div>
                 <div class="col-lg-8 col-md-12">
                     <div class="footer-bottom-right flex-six flex-wrap ">
                         <div class="title-bottom center">© 2024 Nanns. All rights reserved</div>
                ...
                <div class="modal-body space-y-20 pd-40">
                    <div class="wrap-modal flex">
                        <div class="images flex-none">
                            <img src="/nanns/assets/images/section/login.jpg" alt="images">
                        </div>
                        <div class="content">
                ...
                <div class="modal-body space-y-20 pd-40 style2">
                    <div class="wrap-modal flex">
                        <div class="images flex-none relative">
                            <img src="/nanns/assets/images/section/register.jpg" alt="images">
                        </div>
                        <div class="content">
                         ...
                         <div class="compare-thumb-main">
                             <div class="compare-thumb tfcl-compare-listing" data-listing-id="267">
                                 ...
                                 <img loading="lazy" class="compare-listing-img" alt="image"
                                     src="/nanns/assets/images/dashboard/compare1.jpg">
                                 <div class="content">
                                     <h3 class="tfcl-listing-title title">
                                         <a title="Leslie Alexander"
                                             href="/nanns/https://autodealwp.themesflat.co/listing/dongfeng-aeolus-yixuan-mach/">2017
                             ...
                             <div class="compare-thumb tfcl-compare-listing" data-listing-id="266">
                                 ...
                                 <img loading="lazy" class="compare-listing-img" alt="image"
                                     src="/nanns/assets/images/dashboard/compare2.jpg">
                                 <div class="content">
                                     <h3 class="tfcl-listing-title title">
                                         <a title="Leslie Alexander"
                                             href="/nanns/https://autodealwp.themesflat.co/listing/toyota-camry-2025/">2017
                                             BMV X1
                                             xDrive 20d xline</a>
                                     </h3>
                                     <ul class="description">
 ...
 <!-- Javascript -->
 <script src="/nanns/app/js/jquery.min.js"></script>
 <script src="/nanns/app/js/jquery.nice-select.min.js"></script>
 <script src="/nanns/app/js/bootstrap.min.js"></script>
 <script src="/nanns/app/js/plugin.js"></script>
 <script src="/nanns/app/js/switcher.html"></script>
 <script src="/nanns/app/js/shortcodes.js"></script>
 <script src="/nanns/app/js/main.js"></script>
 <script src="/nanns/app/js/sibforms.js" defer></script>
 ...
 <!-- Javascript -->
 <script src="/nanns/app/js/swiper-bundle.min.js"></script>
